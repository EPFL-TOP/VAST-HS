"""
Django settings for VAST_HS project.
...
ASGI_APPLICATION = 'VAST_HS.asgi.application'
WSGI_APPLICATION = 'VAST_HS.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'NAME': str(DBPATH / 'db_VAST-HS.sqlite3'),  # must be a string
    }
}
